...
# Create production vite helper without vite dependencies
echo "Creating production vite helper..."
...
// Empty setupVite function for production
...
# Build the server with production entry point
